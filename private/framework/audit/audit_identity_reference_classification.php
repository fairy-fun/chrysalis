 ...
 *
 * Retired materialized read-model or legacy backup surfaces must be removed
 * from this audit when their backing tables/columns are deleted. Conversely,
 * live projected read-model columns that still carry classval ids must be
 * explicitly classified here instead of being left to unclassified discovery.
 */
